"""
Document classification engine — merged from Pillar 3 into the email pipeline.

Two-tier approach:
  1. Rule-based pre-classifier: filename and content keyword patterns.
  2. AI classifier: Azure OpenAI for ambiguous documents.
"""
...
# ---------------------------------------------------------------------------
# Filename rules — specific types BEFORE generic patterns
# ---------------------------------------------------------------------------
...
def classify_document(
    ...
    Unified classification pipeline:
      1. Filename rules (fast, high confidence)
      2. Content rules if text available
      3. AI classification if provided
